...
function replace(req, res, next){
    ...
    Member.findByPk(id).then(object =>{
        ...
        const phone = req.body.phone ? req.body.address: "";
        const status = req.body.status ? req.body.address: "";
        object.update({
            name:name,
            lastName: lastName,
            address: address,
...
function update(req, res, next){
    ...
    Member.findByPk(id).then(object =>{
        ...
        const phone = req.body.phone ? req.body.address: object.phone;
        const status = req.body.status ? req.body.address: object.phone;
        object.update({
            name:name,
            lastName: lastName,
            address: address,
